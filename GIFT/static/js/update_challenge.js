...
$('.ckeckm').change(function() {
		  ...
		  $("div.select1").replaceWith("Catagory Seleced");
		...
		if(date2==""){
			...
			$("#errorend").show();
			 ...
			 //alert("exp date less than start date");
			    $("#errorend").show();
			    document.getElementById('errorend').innerHTML=" To date can not be less  than start date!";
			    document.getElementById("end_date").style.borderColor = "#E34234";
			     flag=false;
			    }
		...
		if(date3==""){
			$("#errorexp").show();
			 ...
			 //alert("exp date greater than end date");
			    $("#errorexp").show();
			    document.getElementById('errorexp').innerHTML=" Exp date can not be grater  than end date!";
			    document.getElementById("exp_date").style.borderColor = "#E34234";
			     flag=false;
			    }
			 ...
			 //alert("exp date less than start date");
			    $("#errorexp").show();
			    document.getElementById('errorexp').innerHTML=" Exp date can not be less  than today date!";
			    document.getElementById("exp_date").style.borderColor = "#E34234";
			     flag=false;
			    }
		 else{
	...
	//$("#sub").click(function(e){
		...
		//var state = $("#iframe").contents().find(":checkbox").is(":checked");
	     ...
	     {
		 $.ajax({
		   url : '/home/challenge_update/'+challenge,
		   type : "POST",
