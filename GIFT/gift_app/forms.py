...
class ChallengeTypeForm(forms.Form):
    ...
    venue = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control col-sm-3 viewOnlyAccess'}))
...
class CategoryLocationRelForm(forms.Form):
    category = forms.CharField(required=True,widget=forms.TextInput(attrs={'class':'form-control viewOnlyAccess'}))
    location = forms.CharField(required=True,widget=forms.TextInput(attrs={'class':'form-control viewOnlyAccess'}))
