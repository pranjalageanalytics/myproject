...
class GifterRanking(models.Model):
    gift_user = models.ForeignKey(AuthUserGroups, models.DO_NOTHING, db_column='gift_user', blank=True, null=True)
...
class HostFeedback(models.Model):
    gift_user = models.ForeignKey(User, models.DO_NOTHING, db_column='gift_user', blank=True, null=True)
    ...
    point = models.IntegerField(blank=True, null=True)
    host_user = models.ForeignKey(AuthUserGroups, models.DO_NOTHING, db_column='host_user', blank=True, null=True)
    class Meta:
        managed = False
        db_table = 'host_feedback'

class HostRanking(models.Model):
    user = models.ForeignKey(AuthUserGroups, models.DO_NOTHING, db_column='user', blank=True, null=True)
...
class MyChallengeRelRel(models.Model):
    ...
    gifter_rating = models.ForeignKey(GifterRating, models.DO_NOTHING, db_column='gifter_rating', blank=True, null=True)
    class Meta:
        managed = True
...
class NotificationInbox(models.Model):
    ...
    msg_generated_date = models.DateTimeField(blank=True, null=True)
